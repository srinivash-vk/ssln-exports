  ...
  return (
    <footer className="py-20 bg-white border-t border-slate-50 transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex flex-col md:flex-row justify-between items-start gap-16 mb-20 gsap-fade-up">
        ...
        <div className="pt-12 border-t border-slate-50 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] font-medium uppercase tracking-[0.3em] text-slate-300 gsap-fade-up">
