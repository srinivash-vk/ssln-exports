    ...
    <section className="py-24 md:py-32 bg-slate-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <AnimatedElement>
            <div>
              <span className="text-[10px] font-medium tracking-[0.5em] text-slate-400 uppercase mb-4 md:mb-6 block">
                Our Reach
              </span>
              <h2 className="font-display text-4xl sm:text-5xl md:text-6xl font-light text-slate-900 mb-8 md:mb-10 italic leading-tight">
                Serving Global Markets
              </h2>
              <p className="text-slate-500 mb-10 md:mb-12 leading-relaxed font-light tracking-wide max-w-lg text-lg">
                SSLN EXPORTS delivers premium terry towels to customers across
                international markets with reliable logistics, consistent
                quality, and timely shipment solutions. Through efficient global
                supply chain management and export expertise, we ensure seamless
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 md:gap-y-6">
                {MARKETS.map((market, i) => (
                  <div key={i} className="flex items-center gap-4 group">
                    ...
                    <span className="text-sm md:text-base font-medium tracking-wide text-slate-700">
                      {market}
                    </span>
                  </div>
                ))}
              </div>
              <p className="text-slate-500 mt-10 md:mt-12 leading-relaxed font-light tracking-wide max-w-lg text-lg">
                With strong export capabilities and worldwide logistics support, we build long-term partnerships based on trust, quality, and on-time delivery.
                </p>
            </div>
          </AnimatedElement>
          <AnimatedElement delay={0.1}>
            <div className="relative mt-12 lg:mt-0">
              <div className="aspect-[4/3] overflow-hidden rounded-[2rem] shadow-2xl relative z-10">
                <img
                  src="/assets/products/logistics.jpg"
              ...
              {/* <div className="absolute -bottom-6 -left-6 md:-bottom-10 md:-left-10 glass-card p-4 md:p-6 shadow-2xl rounded-2xl hidden sm:block border border-slate-100 z-20">
                <div className="flex flex-col gap-4">
                  <div className="w-32 md:w-48 h-24 md:h-32 overflow-hidden rounded-lg">
                    <img
                      src="/assets/products/logistics.webppg"
