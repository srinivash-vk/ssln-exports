...
import { AnimatedElement, ParallaxElement } from "./AnimatedElement";
  ...
  <div className="animate-marquee whitespace-nowrap text-[9px] md:text-[10px] font-bold tracking-[0.4em] md:tracking-[0.5em] text-white/80 uppercase">
    ...
    Custom Branding   ✦
          ...
          <AnimatedElement delay={0.2}>
            <p className="text-base md:text-xl text-white/70 mb-10 md:mb-12 leading-relaxed max-w-2xl mx-auto font-light tracking-wide">
          ...
          <AnimatedElement delay={0.3}>
            <div className="flex flex-col sm:flex-row gap-6 md:gap-8 justify-center w-full px-4 sm:px-0">
              <a 
                href="#products" 
